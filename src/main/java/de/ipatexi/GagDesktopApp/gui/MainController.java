...
public final class MainController {
    ...
    public void init() throws Exception {
        ...
        //Why do we redeclare it? TODO
        context = new ViewFlowContext();
        
        
        
        // set the default controller
        Flow innerFlow = new Flow(HotSectionController.class);

        //final FlowHandler flowHandler = innerFlow.createHandler(context);
        final MemoryFlowHandler flowHandler = new MemoryFlowHandler(innerFlow,context);
        ...
        context.register("SectionLabel",sectionLabel);
        context.register("Scene",scene);
        
        // side controller will add links to the content flow
        Flow sideMenuFlow = new Flow(SideMenuController.class);
        final FlowHandler sideMenuFlowHandler = new MemoryFlowHandler(sideMenuFlow,context); //sideMenuFlow.createHandler(context);
        
        ExceptionHandler.setExceptionLogging(false);
